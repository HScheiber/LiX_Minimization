function N_Supercell_Out = MDOptimizationLoopFC(IP,Geometry,Directory,MDP_Template,Longest_Cutoff,Coordinate_text,EnergySetting)
    ...
    GROMPP_command = [IP.gmx ' grompp -c ' windows2unix(SuperCellFile) ...
        ...
        warnmax IP.passlog windows2unix(GrompLog_File)];
